    ...
    def __init__(
        ...
        for image in self.instance_images:
            ...
            if args.center_crop:
                ...
                y1, x1, _, _ = transformers.RandomCrop.get_params(img, (target_h, target_w))
            ...
            with accelerator.accumulate(unet):
                ...
                if not args.train_text_encoder:
                    unet_added_conditions = {
                        ...
                        "text_embeds": unet_add_text_embeds.repeat_interleave(elems_to_repeat_text_embeds, 1),
                    }
                    prompt_embeds_input = prompt_embeds.repeat_interleave(elems_to_repeat_text_embeds, 1, 1)
                    model_pred = unet(
                    ...
                    #!!change
                    unet_added_conditions.update(
                        {"text_embeds": pooled_prompt_embeds.repeat_interleave(elems_to_repeat_text_embeds, 1)}
                    )
                    prompt_embeds_input = prompt_embeds.repeat_interleave(elems_to_repeat_text_embeds, 1, 1)
